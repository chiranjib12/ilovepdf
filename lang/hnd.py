...
BAN = {
    ...
    "banCB" : {
        ...
        "अपडेट चैनल": "https://telegram.dog/Greymatter_Bots"
    },
...
\n`कृपया मुझे {}mb आकार` से कम की फ़ाइल भेजें""",
    "bigCB" : {"💎 2Gb सपोर्ट बॉट बनाएं " : "https://github.com/Greymattersbot/ilovepdf"},
...
inline_query = {
    "TOP": {"अब, भाषा चुनें ➟": "nabilanavab"}, "capt": "भाषा सेट करें ️⚙️", "des": "द्वारा: @GreyMatter_bots ❤"
}
