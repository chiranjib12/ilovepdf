...
Вещи с PDF-файлами @Telegram\n\nСпасибо @GreyMatter_Bots за этого замечательного бота 😅""",
    "HomeACB": {
...
BAN = {
    ...
    "banCB" : {
        ...
        "« Обновить канал »": "https://telegram.dog/GreyMatter_Bots"
    },
...
\n`Пожалуйста, пришлите мне файл меньше {}mb Size` 🙃""",
    "bigCB" : {"💎 Создать бота поддержки 2Gb 💎" : "https://github.com/Greymattersbot/ilovepdf"},
